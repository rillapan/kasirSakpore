...
public class Form_User extends javax.swing.JPanel {
    ...
    private void GetData() {
        try {
            ...
            java.sql.ResultSet sql = stm.executeQuery("SELECT * FROM users");
   ...
   private void cariBarang() {
    try {
        ...
        java.sql.ResultSet sql = stm.executeQuery(
            "SELECT * FROM users " +
            "WHERE users.user_Id::text ILIKE '%" + txt_cariUser.getText() + "%' " +
            "OR users.nama_user ILIKE '%" + txt_cariUser.getText() + "%' " +
            "OR users.alamat_user ILIKE '%" + txt_cariUser.getText() + "%' " +
            "OR users.username_user ILIKE '%" + txt_cariUser.getText() + "%' " +
            "OR users.level_user ILIKE '%" + txt_cariUser.getText() + "%' " +
            "OR users.telp_user ILIKE '%" + txt_cariUser.getText() + "%' " +
            "OR users.status_user ILIKE '%" + txt_cariUser.getText() + "%'"
        );
        ...
        // hitung jumlah baris hasil pencarian
        String count_rows = String.valueOf(tbl_user.getRowCount());
        lblcount_rows.setText("Jumlah Data : " + count_rows);
    } catch (SQLException e) {
        JOptionPane.showMessageDialog(null, "Error " + e);
