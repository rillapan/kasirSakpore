...
public class Form_Suplier extends javax.swing.JPanel {
    ...
    try {
        Connection conn = Koneksi.getConnection();
        java.sql.Statement stm = conn.createStatement();
        String keyword = txt_cariSupplier.getText();

        String query = "SELECT * FROM supplier " +
                       "WHERE CAST(supplier_id AS TEXT) ILIKE '%" + keyword + "%' " +
                       "OR nama_supplier ILIKE '%" + keyword + "%' " +
                       "OR alamat_supplier ILIKE '%" + keyword + "%' " +
                       "OR telp_supplier ILIKE '%" + keyword + "%'";
