...
public class Menu_Utama extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panel_navbar.setBackground(new java.awt.Color(153, 0, 0));
    ...
    private void execute() {
        ...
        // === REPORTS ===
MenuItem laporanPenjualan = new MenuItem(null, true, IconBarang, "Laporan Penjualan", new ActionListener() {
    @Override
    public void actionPerformed(ActionEvent e) {
        pn_utama.removeAll();
...
MenuItem laporanPembelian = new MenuItem(null, true, IconBarang, "Laporan Pembelian", new ActionListener() {
    @Override
    public void actionPerformed(ActionEvent e) {
        pn_utama.removeAll();
        pn_utama.add(new Laporan_Pembelian());
        pn_utama.repaint();
        pn_utama.revalidate();
    }
});

MenuItem menuReportPemilik = new MenuItem(IconMaster, false, null, "Report", null, laporanPenjualan, laporanPembelian);
MenuItem menuReportKaryawan = new MenuItem(IconMaster, false, null, "Report", null, laporanPenjualan, laporanPembelian);
